...
<form method="post" action="{{ route('backend.sanpham.update', ['id' => $sp->sp_ma]) }}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea type="text" class="form-control" id="sp_thongTin" name="sp_thongTin" value="{{ old('sp_thongTin', $sp->sp_thongTin) }}">{{ old('sp_thongTin', $sp->sp_thongTin) }}</textarea>
    </div>
    <div class="form-group">
        <label for="sp_danhGia">Đánh giá</label>
        <textarea type="text" class="form-control" id="sp_danhGia" name="sp_danhGia" value="{{ old('sp_danhGia', $sp->sp_danhGia) }}">{{ old('sp_danhGia', $sp->sp_danhGia) }}</textarea>
    </div>
    <div class="form-group">
