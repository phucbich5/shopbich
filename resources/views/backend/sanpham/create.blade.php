...
<form method="post" action="{{ route('backend.sanpham.store') }}">
    ...
    <div class="form-group">
        ...
        <textarea type="text" class="form-control" id="sp_thongTin" name="sp_thongTin" value="{{ old('sp_thongTin') }}"></textarea>
    </div>
    <div class="form-group">
        <label for="sp_danhGia">Đánh giá</label>
        <textarea type="text" class="form-control" id="sp_danhGia" name="sp_danhGia" value="{{ old('sp_danhGia') }}">{{ old('sp_danhGia') }}</textarea>
    </div>
    <div class="form-group">
