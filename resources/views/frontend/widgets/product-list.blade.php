        ...
        <div>
            ...
            <div class="row isotope-grid">
                @foreach ($data as $index => $sp)
                    <div class="col-6 col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item loai-{{ $sp->l_ma }}" style="padding:0;border:1px solid #f3f3f3">
                        <!-- Block2 -->
                        <div class="block2">
            ...
            <div class="flex-c-m flex-w w-full p-t-45">
                <a  data-src="1" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04 load_more">
                    Load More
                </a>
            </div>
        </div>
