...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('themes/cozastore/vendor/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css"
...
<body class="animsition">
                            ...
                            <div class="wrap-slick3 flex-sb flex-w">
                                ...
                                <div class="slick3 gallery-lb">
                                    <div class="item-slick3"
                                        data-thumb="{{ asset('themes/cozastore/images/product-detail-01.jpg') }}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{ asset('themes/cozastore/images/product-detail-01.jpg') }}"
                                                alt="IMG-PRODUCT">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href="{{ asset('themes/cozastore/images/product-detail-01.jpg') }}">
                                    ...
                                    <div class="item-slick3"
                                        data-thumb="{{ asset('themes/cozastore/images/product-detail-02.jpg') }}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{ asset('themes/cozastore/images/product-detail-02.jpg') }}"
                                                alt="IMG-PRODUCT">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href="{{ asset('themes/cozastore/images/product-detail-02.jpg') }}">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item-slick3"
                                        data-thumb="{{ asset('themes/cozastore/images/product-detail-03.jpg') }}">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{ asset('themes/cozastore/images/product-detail-03.jpg') }}"
                                                alt="IMG-PRODUCT">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href="{{ asset('themes/cozastore/images/product-detail-03.jpg') }}">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $('.load_more').on('click', function(e) {
            ...
            $.ajax({
                ...
                url: '/load_products?page='+ $current_page ,
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    $('#load_products_container').append(data['template'])
                    $('#'+$current_page).attr('id', $next_page)
    ...
    <script>
        $('#keyword_product').on('keyup', function() {
            var keyword = $(this).val();
            if (keyword != '') {
                $.ajax({
                    type: "get",
                    url: "/searchAjax_product",
                    data: {
                        keyword: keyword
                    },
                    dataType: 'json',
                ...
                $('#listSearch_product').hide();
                $('#list_product').show();
                
                $('#listSearch_product').html('');
            }
        })
    </script>
